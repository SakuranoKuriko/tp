...
create table usr (id int(11) not null primary key unique, pw varchar(255) not null, permission int(11) not null, usrgroup int(11) not null, name varchar(255) not null, homepage varchar(255), steam varchar(255), github varchar(255));